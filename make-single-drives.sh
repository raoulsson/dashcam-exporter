...
# e.g.:
#       ./make-single-drives.sh                # encode every drive on the card
#       ./make-single-drives.sh 13             # only drive 13
#       ./make-single-drives.sh 13 14          # drives 13 and 14
#
