...
from dashcam_exporter.infrastructure.media.motion import (
    ...
    find_drive_away_in_group_video, _HAVE_EGO,
    DRIVE_RESUME_THRESHOLD_KMH, DRIVE_RESUME_SUSTAIN_SECS,
    EGO_FPS, EGO_CONTEXT_PAD, EGO_END_PAD,
    _EGO_FLOW_CACHE,
)
...
def main() -> int:
    ...
    for env_path in (CHECKOUT.env_file(), Path.cwd() / ".env"):
