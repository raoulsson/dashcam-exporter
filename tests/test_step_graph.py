...
AUTHORED_INBOUND = {
    M.Strategy.UPLOADER: {
        ...
        BUILD: {BUILD, META, PREVIEW, EXCLUDE, RENDER, TRANSCRIBE, UPLOAD},
        UPLOAD: {UPLOAD, BUILD, META, PREVIEW, EXCLUDE, RENDER, TRANSCRIBE},
    ...
    M.Strategy.LOCAL_PAGE: {
        ...
        BUILD: {BUILD, META, PREVIEW, EXCLUDE, RENDER, TRANSCRIBE},
        UPLOAD: set(),
        CLEAN_WS: {IMPORT, META, PREVIEW, EXCLUDE, RENDER, BUILD, TRANSCRIBE},
...
class TestStrategySplit(GraphTest):
    ...
    def test_only_the_publishing_items_declare_different_edges(self):
        ...
        self.assertEqual(differing,
                         {META, PREVIEW, EXCLUDE, RENDER, BUILD, TRANSCRIBE, UPLOAD})
