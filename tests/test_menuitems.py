...
OUTBOUND = {
    UPLOADER: {
        ...
        BUILD:    {META, PREVIEW, EXCLUDE, RENDER, TRANSCRIBE, BUILD, UPLOAD, CLEAN_WS,
                   ERASE_CARD},
        TRANSCRIBE: {IMPORT, META, PREVIEW, EXCLUDE, RENDER, TRANSCRIBE, BUILD,
...
INBOUND = {
    UPLOADER: {
        META:     {IMPORT, META, PREVIEW, EXCLUDE, RENDER, BUILD, UPLOAD, TRANSCRIBE},
        PREVIEW:  {META, PREVIEW, EXCLUDE, RENDER, BUILD, UPLOAD, TRANSCRIBE},
        EXCLUDE:  {META, PREVIEW, EXCLUDE, RENDER, BUILD, UPLOAD, TRANSCRIBE},
        RENDER:   {META, PREVIEW, RENDER, BUILD, UPLOAD, TRANSCRIBE},
        BUILD:    {META, PREVIEW, RENDER, BUILD, UPLOAD, TRANSCRIBE},
        UPLOAD:   {META, PREVIEW, EXCLUDE, RENDER, BUILD, UPLOAD, TRANSCRIBE},
        CLEAN_WS: {IMPORT, META, PREVIEW, EXCLUDE, RENDER, BUILD, UPLOAD, TRANSCRIBE,
                   CLEAN_WS},
        ERASE_CARD: {IMPORT, META, PREVIEW, EXCLUDE, RENDER, BUILD, UPLOAD, TRANSCRIBE},
    },
    LOCAL: {
        META:     {IMPORT, META, PREVIEW, EXCLUDE, RENDER, BUILD, TRANSCRIBE},
        PREVIEW:  {META, PREVIEW, EXCLUDE, RENDER, BUILD, TRANSCRIBE},
        EXCLUDE:  {META, PREVIEW, EXCLUDE, RENDER, BUILD, TRANSCRIBE},
        RENDER:   {META, PREVIEW, RENDER, BUILD, TRANSCRIBE},
        BUILD:    {META, PREVIEW, RENDER, BUILD, TRANSCRIBE},
        UPLOAD:   set(),
        CLEAN_WS: {IMPORT, META, PREVIEW, EXCLUDE, RENDER, BUILD, TRANSCRIBE, CLEAN_WS},
        ERASE_CARD: {IMPORT, META, PREVIEW, EXCLUDE, RENDER, BUILD, TRANSCRIBE},
    },
}
